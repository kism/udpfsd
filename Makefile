...
.PHONY: all clean build-linux-amd64 build-linux-arm64 build-linux-armv7 build-linux-armv6 build-darwin-amd64 build-darwin-arm64 build-windows-amd64 build-windows-arm64

all: build-linux-amd64 build-linux-arm64 build-linux-armv7 build-linux-armv6 build-darwin-amd64 build-darwin-arm64 build-windows-amd64 build-windows-arm64
